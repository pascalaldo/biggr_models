...
from biggr_models import routes
...
def start_debug_server():
    ...
    for dir, _, files in chain(
        os.walk("biggr_models/templates"),
        # os.walk("biggr_models/static/js"),
        # os.walk("biggr_models/static/css"),
        # os.walk("biggr_models/static/assets"),
    ):
